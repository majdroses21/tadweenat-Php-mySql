          ...
          <div class="add-category">
            ...
            <div class="mb-3">
              ...
              <select name="" id="cate" class="form-control">
                ...
                <option value="">إسلاميات</option>
                <option value="">صحة</option>
                <option value="">حيوانات اليفة</option>
                <option value="">طعام</option>
                <option value="">تقنيات</option>
              </select>
            </div>
            <div class="mb-3">
              <label for="img">صورة المقالة</label>
              <input type="file" id="img" class="form-control">
            </div>
            <div class="form-control">
              <label for="contant">نص المقال</label>
              <TExtarea class="form-control" rows="7" cols="30"></TExtarea>
            </div>
              <button class="btn btn-add-categ">نشر المقال</button>
            </form>
          </div>
        </div>
      </div>
